...
import { FOR_COACHES_FAQ_EN, FOR_COACHES_FAQ_FA } from '@/lib/forCoachesFaq';
    ...
    features: {
      ...
      items: [
        ...
        },
        {
          ...
          desc: 'Request a daily AI-generated coaching report analyzing your entire client roster.',
        },
        {
          icon: 'chart',
    ...
    features: {
      ...
      items: [
        ...
        },
        {
          ...
          desc: 'یک گزارش کوچینگ روزانه تولیدشده توسط هوش مصنوعی درخواست کنید که تمام کلاینت‌هایتان را تحلیل می‌کند.',
        },
        {
          icon: 'chart',
